...
class Modulus(Operation):
    ...
    execute the remainder of the division of two numbers.
    """
...
class IntegerDivision(Operation):
    ...
    Performs the division of one number by another and return rounded down int.
    """
...
class AbsoluteDifference(Operation):
    ...
    Performs the subtraction of one number returning absolute difference.
    """
