...
class TestIntegerDivision(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "6.5", "b": "2", "expected": "3"},
        "negative_numbers": {"a": "-3.2", "b": "-2", "expected": "1"},
        "mixed_signs": {"a": "-4.1", "b": "1.5", "expected": "-2"},
        "divide_zero": {"a": "0", "b": "5", "expected": "0"},
    }
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "6", "b": "100", "expected": "6"},
        "negative_numbers": {"a": "-5", "b": "-25", "expected": "20"},
        "mixed_signs": {"a": "-4", "b": "8", "expected": "-50"},
        "divide_zero": {"a": "0", "b": "5", "expected": "0"},
    }
